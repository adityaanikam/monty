...
impl MontyRun {
    ...
    #[expect(
        ...
        reason = "the test API mirrors the owned tracker accepted by normal execution"
    )]
    ...
    #[expect(
        clippy::needless_pass_by_value,
        reason = "the public API transfers tracker ownership for the duration of the run"
    )]
    pub fn run(
        &self,
        inputs: Vec<MontyObject>,
