...
pub(crate) fn class_today(heap: &mut HeapReader<'_>, args: ArgValues) -> RunResult<AttrCallResult> {
...
pub(crate) fn class_fromisoformat(heap: &mut HeapReader<'_>, args: ArgValues, interns: &Interns) -> RunResult<Value> {
...
pub(crate) fn py_sub_date(a: Date, b: Date, heap: &mut HeapReader<'_>) -> Result<Option<Value>, ResourceError> {
...
pub(crate) fn py_add(date: Date, delta: TimeDelta, heap: &mut HeapReader<'_>) -> Result<Option<Value>, ResourceError> {
