...
impl ReMatch {
    ...
    fn get_group(&self, n: i64, heap: &HeapReader<'_>) -> RunResult<Value> {
        match n.cmp(&0) {
    ...
    fn get_group_by_name(&self, name: &str, heap: &HeapReader<'_>) -> RunResult<Value> {
...
impl ReMatch {
    ...
    fn get_groups(&self, heap: &HeapReader<'_>) -> RunResult<Value> {
...
fn extract_optional_group_arg(args: ArgValues, name: &str, default: i64, heap: &mut HeapReader<'_>) -> RunResult<i64> {
