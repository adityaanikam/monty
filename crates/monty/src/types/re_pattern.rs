...
impl RePattern {
    ...
    pub fn search(&self, subject: &Value, text: &str, heap: &HeapReader<'_>) -> RunResult<Value> {
    ...
    pub fn match_start(&self, subject: &Value, text: &str, heap: &HeapReader<'_>) -> RunResult<Value> {
    ...
    ///
    /// Returns a `ReMatch` heap object on success, or `Value::None` if no match.
    pub fn fullmatch(&self, subject: &Value, text: &str, heap: &HeapReader<'_>) -> RunResult<Value> {
    ...
    pub fn findall(&self, text: &str, heap: &HeapReader<'_>) -> RunResult<Value> {
    ...
    pub fn sub(&self, repl: &str, text: &str, count: usize, heap: &HeapReader<'_>) -> RunResult<Value> {
    ...
    pub fn split(&self, text: &str, maxsplit: i64, heap: &HeapReader<'_>) -> RunResult<Value> {
    ...
    pub fn finditer(&self, subject: &Value, text: &str, heap: &HeapReader<'_>) -> RunResult<Value> {
