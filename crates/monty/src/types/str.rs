...
pub fn allocate_string(s: impl AsRef<str> + Into<Box<str>>, heap: &HeapReader<'_>) -> Result<Value, ResourceError> {
...
pub fn allocate_string_no_interning(s: impl Into<Box<str>>, heap: &HeapReader<'_>) -> Result<Value, ResourceError> {
...
pub fn allocate_char(c: char, heap: &HeapReader<'_>) -> Result<Value, ResourceError> {
    if c.is_ascii() {
...
pub(crate) fn concat_allocate_str(a: &str, b: &str, heap: &HeapReader<'_>) -> Result<Value, ResourceError> {
