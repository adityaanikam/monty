...
use crate::{
    ...
    resource::{ResourceError, check_div_size, check_lshift_size, check_mult_size, check_pow_size, check_repeat_size},
    types::{
...
mod tests {
    ...
    use super::*;
    use crate::{
        PrintWriter, heap::HeapReader, intern::InternerBuilder, resource::ResourceTracker,
