...
use monty::{
    CompileOptions, ExcType, ExtFunctionResult, MontyException, MontyObject, MontyRun, NameLookupResult, PrintWriter,
...
fn drive_until_settled(mut progress: RunProgress) -> Result<RunProgress, monty::MontyException> {
    loop {
        match progress {
